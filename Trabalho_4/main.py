...
# Adiciona o caminho de Trabalho_4
trabalho_4_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../Trabalho_4'))
sys.path.insert(0, trabalho_4_path)

# Importa o router de eventos do Trabalho_4
try:
    import eventos
    eventos_router = eventos.router
    pubsub_disponivel = True
except ImportError as e:
    print(f"⚠️  Aviso: Pub/Sub não disponível: {e}")
